...
var msg4 = "By closing this window you acknowledge that your experience on this website will be degraded";
var msg5 = "Close This Window";
...
function _ie6(str) {
    ...
    _closeds.margin = "0 0 0 0";
    _closelds.color = "#000";
    _closelds.display = "block";
    _closelds.width = "auto";
    ...
    _closeld.onmouseover = function() {
        _closelds.background = "#000";
        _closelds.color = "#FFF";
    };
    
    _closeld.onmouseout = function() {
        _closelds.background = "transparent";
        _closelds.color = "#000";
    };
